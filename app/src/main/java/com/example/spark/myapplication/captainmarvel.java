...
public class captainmarvel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_captainmarvel);
    ...
    public boolean validateReviews(String reviews,float ratings){
        if(reviews.equals("") && ratings == 0){
            Toast.makeText(captainmarvel.this, "Enter a review", Toast.LENGTH_SHORT).show();
            return false;
        }else if(reviews.equals("") || ratings == 0){
            Toast.makeText(captainmarvel.this, "Check the fields", Toast.LENGTH_SHORT).show();
            return false;
        }else{
            return true;
        }
    ...
    public void submitReview1(View view){
        String moviename = "Captain Marvel.";

        int userID = MainActivity.userID;

        review = findViewById(R.id.captain_review);

        rating = findViewById(R.id.captain_rating);
        ...
        if(validateReviews(review1,rating1) == true){
            ...
            if(ins == -1){
                Toast.makeText(captainmarvel.this, "Submission Failed", Toast.LENGTH_SHORT).show();
            }else if(ins >= 0){
                Toast.makeText(captainmarvel.this, "Submission Successful", Toast.LENGTH_SHORT).show();
            }
