...
public class godzilla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_godzilla);
    ...
    public boolean validateReviews(String reviews,float ratings){
        if(reviews.equals("") && ratings == 0){
            Toast.makeText(godzilla.this, "Enter a review", Toast.LENGTH_SHORT).show();
            return false;
        }else if(reviews.equals("") || ratings == 0){
            Toast.makeText(godzilla.this, "Check the fields", Toast.LENGTH_SHORT).show();
            return false;
        }else{
            return true;
        }
    ...
    public void submitReview3(View view){
        String moviename = "Godzilla : King of Monsters.";

        int userID = MainActivity.userID;

        review = findViewById(R.id.godzilla_review);

        rating = findViewById(R.id.godzilla_rating);
        ...
        if(validateReviews(review1,rating1) == true){
            ...
            if(ins == -1){
                Toast.makeText(godzilla.this, "Submission Failed", Toast.LENGTH_SHORT).show();
            }else if(ins >= 0){
                Toast.makeText(godzilla.this, "Submission Successful", Toast.LENGTH_SHORT).show();
            }
